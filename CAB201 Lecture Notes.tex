...
\begin{definition}[Literal]
    ...
    and the string \mintinline{csharp}{"dog"} we would say the \emph{``variable dog''} % chktex 18
...
\begin{itemize}
    ...
    \item Identifiers are case sensitive (``\mintinline{csharp}{Foo}''
          and ``\mintinline{csharp}{foo}'' are different variables) % chktex 38
...
\mintinline{csharp}{ulong} type to any integer \linebreak depending the
...
\begin{table}[H]
    ...
    \begin{tabular}
        ...
        \mintinline{csharp}!x + y!, \mintinline{csharp}!x - y!                                                                                                             & Additive                                                                                                                                     \\ % chktex 8
        ...
        \mintinline{csharp}!x == y!, \mintinline{csharp}{x != y}                                                                                                           & Equality                                                                                                                                     \\ % chktex 26
        ...
        \mintinline{csharp}!x ?? y!                                                                                                                                        & Null-coalescing operator                                                                                                                     \\ % chktex 26
        \mintinline{csharp}!c ? t : f!                                                                                                                                     & Conditional operator                                                                                                                         \\ % chktex 26
...
\mintinline{csharp}{if} statement.% chktex 13
...
\begin{enumerate}
    \item Execute \mintinline{csharp}{STATEMENTS} if
          \mintinline{csharp}{CONDITION == true}. % chktex 13
    \item Goto Step 1.
\end{enumerate}
...
Fundamental semantics:
\begin{enumerate}
    \item Execute \mintinline{csharp}{STATEMENTS}. % chktex 13
    \item Goto Step 1 if \mintinline{csharp}{CONDITION == true}.
\end{enumerate}
...
Fundamental semantics:
\begin{enumerate}
    \item Execute \mintinline{csharp}{INIT}. % chktex 13
    \item Execute \mintinline{csharp}{STATEMENTS} if
          \mintinline{csharp}{CONDITION == true}. % chktex 13
...
statements or the \mintinline{csharp}{UPDATE} statement (in the \mintinline{csharp}{for} structure) % chktex 13
...
must be equal to the specified \mintinline{csharp}{SIZE}. % chktex 13
...
the C\# interactive CLI. % chktex 13
...
the base classes implementation using the \mintinline{csharp}{base}
keyword.
\begin{minted}{csharp}
class A
{
...
\mintinline{csharp}{ToString()}. These are all virtual methods that are
...
\end{minted}
The program attempts to use the current classes implementation of
