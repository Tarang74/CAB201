...
\begin{table}[H]
    ...
    % \label{}
\end{table}
By default, C\# implicitly converts whole numbers to \lstinline!int! and floating-point numbers to \lstinline!double!.
...
By default C\texttt{\#} automatically assigns the \lstinline!int! type to any whole number
and \lstinline!double! to any floating-point number.
\begin{lstlisting}
$ (100).GetType()
System.Int32
$ (100.0).GetType()
