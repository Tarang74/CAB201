...
\lstset{
	language=c,                % Language for syntax highlighting
...
the parameters of the overloaded methods into another method inside the same class
...
A virtual method provides a default implementation for a method that may be reimplemented
